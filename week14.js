...
const myInformation = [`Sophie`, `24 jan`, `aquarius`];
...
const shiftCountries = countries.shift();
console.log(shiftCountries);
...
let sum = squaredNumbers[0] + squaredNumbers[9];
console.log(sum);
//Задание 11
